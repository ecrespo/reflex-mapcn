...
| A-12 | BAJO | Datos | El histórico USGS anterior a 1973 es incompleto para Venezuela (solo grandes eventos); el slider desde 1900 puede sugerir ausencia de actividad. | PRD REQ-SIS-004 | Mostrar nota en el panel: "Catálogo USGS: completo aprox. desde 1973 para M ≥ 4.5" | **Aplicado** (T-016, 2026-09-11) |
